...
import { TouchableWithoutFeedback, View, Text, StyleSheet, Dimensions, Modal } from "react-native";
    ...
    return(
        <TouchableWithoutFeedback onLongPress={(e) => {
            ...
            <View className="flex flex-col">
                ...
                <View className="flex-1 absolute" style={{elevation: 3, zIndex: 1}}>
